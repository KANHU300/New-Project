  ...
  return (
    <div>
      <div className="orders-topData">
        <div className="xchange-orders-top"><h1 className="order-id">#8998595</h1><div className="right-invoice">
          {/* custom button  */}
          <CustomButton text="Invoice" color="#BFBFBF" textColor="#141414" />
          <CustomButton text="Exchange" color="#24a804" textColor="#FFFFFF" />
        </div></div>
        
        

        <div className="order-item-top xchnge-order">
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="left-Cartitem">
                <div className="cart-product-detail">
                  ...
                  <div className="exchnge-icon-top">
                    <img src="/images/exchange.svg" alt="" className="exchange-iccon" />
                  </div>
                </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="right-price-details">
                ...
                <hr className="line-edit"></hr>
                <h1 className="paid-By">
                  Paid By UPI (<span>7898545889@ybl</span>){" "}
                  <Button className="copy-btn">
                    <i class="far fa-clone"></i>
                  </Button>
                </h1>
